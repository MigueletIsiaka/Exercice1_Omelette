    ...
    by HALF-BAKED SOFTWARE
       Readme.txt file
(Windows / Linux (Wine) version)

 CONTENTS

1. Notes for Upgrading
2. What is HOT POTATOES?
3. History and Previous 
   Versions
4. Freeware Distribution
...
If you are upgrading to version 7.0 from 6.x or earlier, please note that THE SOURCE FILES HAVE CHANGED CONSIDERABLY. This is to make them compatible with modern web standards. If you have been using customized source files, then they will not work with version 7.0, and you will have to re-do your customizations based on the new source files. But you should be able to run 6.x and 7.x versions side by side on the same system.
...
The version 7.0 output pages are fully XHTML5-compliant.
...
Commercial aspects of Hot Potatoes (such as licencing) are handled by Half-Baked Software Inc:
 ...
 3. History and Previous Versions
...
Version 6.0 was released in December 2003.
...
Version 7.0, incorporating valid HTML5 output, was released in January 2019. (Very early versions were numbered 6.4.)
...
The HOT POTATOES suite is copyright Martin Holmes, Stewart Arneil, Hilary Street, Half-Baked Software, and the University of Victoria Humanities Computing and Media Centre 1996-2019. 